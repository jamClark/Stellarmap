...
namespace Stellarmap
	...
	/// </summary>
	public partial class RightComboMapBuilder : AFunctionControl
		{
		Dictionary<string,string> Mapping = new Dictionary<string,string>();
		FuncParamType ParamType = FuncParamType.Mapping;
		
		public RightComboMapBuilder()
			{
			InitializeComponent();
			}
		...
		public override ControlType FunctionControlType
			{
			get { return ControlType.RightComboMapBuilder; }
			}
		...
		private void button1_Click(object sender,EventArgs e)
			{
			using(BasicTextEditor editor = new BasicTextEditor(OnCallback,this.Key.Text))
				{
